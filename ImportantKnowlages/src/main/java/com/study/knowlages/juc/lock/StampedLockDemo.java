 ...
 * @Version 1.0
 * 比读写锁(ReentenReadWriteLock)更快的锁 邮戳锁(StampedLock) 也叫做票据锁
 * 在并发读的时候可以写入
 *
 */
public class StampedLockDemo {
    ...
    public void write(){
        ...
        System.out.println(Thread.currentThread().getName() + "\t 开始准备写入数据");
        ...
        System.out.println(Thread.currentThread().getName() + "\t 开始写入数据完成~");
    }
