 ...
 *
 * 查看写出的kafka主题是否有数据
 * bin/kafka-console-consumer.sh --bootstrap-server 192.168.200.144:9092 --topic dwd_trade_order_detail
 *
 */
...
public class DwdTradeOrderDetail {
    ...
    public static void main(String[] args) {
        ...
        tableEnv.executeSql("" +
                ...
                ")" + MyKafkaUtil.getKafkaDDL("dwd_trade_order_pre_process", "order_detail_test"));


        //TODO 3. 过滤出来下单数据,即新增数据
