 ...
 * @Version 1.0
 * 交易域退款成功事务事实表
 * bin/kafka-console-consumer.sh --bootstrap-server 192.168.200.144:9092 --topic dwd_trade_refund_pay_suc
 *
 */
...
//        System.setProperty("HADOOP_USER_NAME", "wangziyu1");
        ...
        tableEnv.executeSql("create table topic_db(" +
                ...
                "`ts` string " +
                ")" + MyKafkaUtil.getKafkaDDL("topic_db", "refund_pay_suc_test"));
