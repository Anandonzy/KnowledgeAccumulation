...
/**
 * @Author wangziyu1
 * @Date 2022/8/25 09:40
 * @Version 1.0
 * 交易域订单预处理表
 * 明细数据join起来 有leftjoin
 * 中间涉及到回撤流 回撤流必须设置主键 根据主键进行回撤的.
 */
...
public class DwdTradeOrderPreProcess {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //TODO 2. 创建topic_db 表
        tableEnv.executeSql(MyKafkaUtil.getTopicDb("order_pre_process_test"));
        ...
        //转换为流并打印测试
        //tableEnv.toAppendStream(orderInfoTable, Row.class).print(">>>>1");
        ...
        //转换为流并打印测试
        //tableEnv.toAppendStream(orderActivityTable, Row.class).print(">>>>2");
        ...
        //tableEnv.toAppendStream(orderCouponTable, Row.class).print(">>>3");

        //TODO 7.创建 base_dic LookUp表
        tableEnv.executeSql(MysqlUtil.getBaseDicLookUpDDL());

        //current_row_timestamp 有时区的问题
        //需要转换时区 写法如下
        ...
        //转换为流并打印测试
        //tableEnv.toRetractStream(resultTable, Row.class).print(">>>>4");

        //TODO 9.创建 upsert-kafka 表 必须要有主键
        tableEnv.executeSql("" +
                ...
                "    primary key(id) not enforced " + //回撤流必须要有主键
