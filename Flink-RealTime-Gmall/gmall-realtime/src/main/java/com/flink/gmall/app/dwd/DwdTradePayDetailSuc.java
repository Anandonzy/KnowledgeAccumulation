 ...
 * 交易域支付成功事务事实表
 * 查看写出的kafka主题是否有数据
 * bin/kafka-console-consumer.sh --bootstrap-server 192.168.200.144:9092 --topic dwd_trade_pay_detail_suc
 *
 */
...
public class DwdTradePayDetailSuc {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //System.setProperty("HADOOP_USER_NAME", "wangziyu");
        ...
        tableEnv.executeSql(MyKafkaUtil.getTopicDb("pay_detail_suc_test"));
        ...
        tableEnv.executeSql("" +
                ...
                ")" + MyKafkaUtil.getKafkaDDL("dwd_trade_order_detail","pay_detail_suc_order_test"));
